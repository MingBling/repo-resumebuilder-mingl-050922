...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { Address: @resume.Address, Email: @resume.Email, Image_Url: @resume.Image_Url, Name: @resume.Name, Phone: @resume.Phone, Role: @resume.Role } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { Address: @resume.Address, Email: @resume.Email, Image_Url: @resume.Image_Url, Name: @resume.Name, Phone: @resume.Phone, Role: @resume.Role } }
